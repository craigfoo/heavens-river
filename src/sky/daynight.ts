...
const KEYS: Key[] = [
  ...
  { t: 0.34, elev: 18, sun: '#ffd09a', sunI: 2.9, zenith: '#3a68b8', horizon: '#e8c8a8', glow: '#ffd8a0', amb: '#98a6c0', hemiSky: '#9fb8e0', hemiGround: '#5a4630', hemiI: 0.9, night: 0, tube: '#ffe6c0', exposure: 0.92 },
  { t: 0.42, elev: 60, sun: '#fff0dc', sunI: 2.0, zenith: '#4a7ccc', horizon: '#c8d8ea', glow: '#fff4dc', amb: '#a8bcd8', hemiSky: '#b0c8ea', hemiGround: '#5e5038', hemiI: 0.9, night: 0, tube: '#fff6e8', exposure: 0.84 },
  { t: 0.5, elev: 90, sun: '#fff4e6', sunI: 1.75, zenith: '#4b7fd0', horizon: '#c6d6ea', glow: '#fff6e6', amb: '#aac0dc', hemiSky: '#b4ccee', hemiGround: '#605238', hemiI: 0.85, night: 0, tube: '#fff8ee', exposure: 0.82 },
  { t: 0.58, elev: 60, sun: '#fff0dc', sunI: 2.0, zenith: '#4a7ccc', horizon: '#c8d8ea', glow: '#fff4dc', amb: '#a8bcd8', hemiSky: '#b0c8ea', hemiGround: '#5e5038', hemiI: 0.9, night: 0, tube: '#fff6e8', exposure: 0.84 },
  { t: 0.66, elev: 18, sun: '#ffd09c', sunI: 2.9, zenith: '#3a64b0', horizon: '#ecc4a0', glow: '#ffd090', amb: '#9ea2bc', hemiSky: '#a0b4dc', hemiGround: '#5c4430', hemiI: 0.9, night: 0, tube: '#ffe0b0', exposure: 0.92 },
